...
const Navbar = () => {
  ...
  },
  {
    ...
    path: "/academics",
    dropdown: [
      { label: "UG Programme", path: "/academics/ug-programme" },
      { label: "PG Programme", path: "/academics/pgprogramme" },
    ...
    dropdown: [
      {
        ...
        submenu: [
          ...
          { label: "Admission Committee", path: "/committees/admission-committee-cn" },
          { label: "Library Committee", path: "/committees/library-committee-cn" },
          {
            label: "Maintenance Committee",
            path: "/committees/maintenance-committee-cn",
          },
          { label: "Hostel Committee", path: "/committees/hostel-committee-cn" },
          { label: "Discipline Committee", path: "/committees/discipline-committee-cn" },
          { label: "Cultural Committee", path: "/committees/cultural-committee-cn" },
          {
            label: "Social Media Committee",
            path: "/committees/social-media-committee-cn",
          },
          { label: "Transport Committee", path: "/committees/transport-committee-cn" },
          { label: "Website Committee", path: "/committees/website-committee-cn" },
          { label: "Student information Committee", path: "/committees/student-information-committee-cn" },
          { label: "Finance Committee", path: "/committees/finance-committee-cn" },
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: "National Service Scheme (NSS)", path: "/committees/cells/nss-cn" },
        ],
      },
      {
        label: "Clubs",
        ...
        submenu: [
          ...
          { label: "Achariya Code Club", path: "/committees/clubs/achariya-code-club" },
        ],
      },
    ],
  },
  ...
  return (
    <>
      ...
      <HeaderBannerSection />
      <NewsTicker />
      <nav className="bg-purple relative">
