...
// -------------------------------------------------------
const sanitizeItem = (item: any): RecruitersData => ({
  _id: item?._id,
  data: {
...
const EMPTY_DATA: RecruitersData = {
  data: {
...
const RecruitersDataManager: React.FC = () => {
  const [data, setData] = useState<RecruitersData[]>([]);
    ...
    return (
      <div className="form-container" style={{ maxWidth: 800 }}>
        <h3 style={{ marginBottom: "1.5rem" }}>
          {isNew ? "Create New Recruiters Data" : "Edit Recruiters Data"}
        </h3>
        ...
        <div style={{ marginBottom: "2rem" }}>
          ...
          >
            <strong>Recruiter Logos ({safe.data.logos.length})</strong>
