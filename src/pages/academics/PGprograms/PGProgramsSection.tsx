    ...
    <div className="flex-1 p-6 border-r border-gray-400">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h1 className="text-2xl font-bold text-purple capitalize mb-4 md:mb-0">
          {activeCategory === "existing" ? "Existing PG Programs" : "Proposed PG Programs"}
        </h1>
        ...
        <div className="relative w-full md:w-96">
          <input
            ...
            className="w-full px-4 py-2 pl-10 border border-gray-400 rounded-lg
      ...
      {filtered.length > 0 ? (
        ...
        <p className="text-center text-gray-500 mt-10">No PG programs found.</p>
      )}
...
export default PGProgramsSection;
